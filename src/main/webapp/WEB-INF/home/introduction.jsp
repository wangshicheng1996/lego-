...
<script type="text/javascript"
	src="${ctx}/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
		...
		<div class="scoll">
			<section class="slider">
				<div class="flexslider">
					<ul class="slides">
						<li><img src="${ctx}/images/01.jpg" title="pic" /></li>
						<li><img src="${ctx}/images/02.jpg" /></li>
						<li><img src="${ctx}/images/03.jpg" /></li>
					</ul>
				</div>
			</section>
		</div>
			...
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a href="${ctx}/images/01.jpg"><img src="${ctx}/images/01_mid.jpg"
							alt="细节展示放大镜特效" rel="${ctx}/images/01.jpg" class="jqzoom" /></a>
					</div>
					<ul class="tb-thumb" id="thumblist">
						<li class="tb-selected">
							<div class="tb-pic tb-s40">
								<a href="#"><img src="${ctx}/images/01_small.jpg"
									mid="${ctx}/images/01_mid.jpg" big="${ctx}/images/01.jpg"></a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
								<a href="#"><img src="${ctx}/images/02_small.jpg"
									mid="${ctx}/images/02_mid.jpg" big="${ctx}/images/02.jpg"></a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
								<a href="#"><img src="${ctx}/images/03_small.jpg"
									mid="${ctx}/images/03_mid.jpg" big="${ctx}/images/03.jpg"></a>
							</div>
						</li>
					</ul>
				</div>
		...
		<div class="match">
			...
			<div class="match-comment">
				<ul class="like_list">
					<li>
						<div class="s_picBox">
							<a class="s_pic" href="#"><img src="${ctx}/images/cp.jpg"></a>
					...
					<li>
						<div class="s_picBox">
							<a class="s_pic" href="#"><img src="${ctx}/images/cp2.jpg"></a>
			...
			<div class="browse">
				<div class="mc">
					<ul>
						...
						<li class="first">
							<div class="p-img">
								<a href="#"> <img class="" src="${ctx}/images/browse1.jpg">
								</a>
							</div>
							<div class="p-name">
						...
						<div class="am-tab-panel am-fade am-in am-active">
							...
							<div class="details">
								...
								<div class="twlistNews">
									<img src="${ctx}/images/tw1.jpg" /> <img src="${ctx}/images/tw2.jpg" />
									<img src="${ctx}/images/tw3.jpg" /> <img src="${ctx}/images/tw4.jpg" />
									<img src="${ctx}/images/tw5.jpg" /> <img src="${ctx}/images/tw6.jpg" />
									<img src="${ctx}/images/tw7.jpg" />
								</div>
							</div>
							<div class="clear"></div>
							...
							<ul class="am-comments-list am-comments-list-flip">
								<li class="am-comment">
									<!-- 评论容器 --> <a href=""> <img class="am-comment-avatar"
										src="${ctx}/images/hwbn40x40.jpg" /> <!-- 评论者头像 -->
								</a>
								...
								<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
									<li>
										<div class="i-pic limit">
											<img src="${ctx}/images/imgsearch1.jpg" />
											<p>
			...
			<div id="wrap">
					...
					<div class="ibar_login_box status_login">
						<div class="avatar_box">
							<p class="avatar_imgbox">
								<img src="${ctx}/images/no-img_mid_.jpg" />
							</p>
							<ul class="user_info">
								<li>用户名：sl1903</li>
								<li>级&nbsp;别：普通会员</li>
				...
				<div id="broadcast" class="item">
					<a href="#"> <span class="chongzhi"><img
							src="${ctx}/images/chongzhi.png" /></span>
					</a>
					<div class="mp_tooltip">
				...
				<div class="quick_toggle">
					...
					<li class="qtitem"><a href="#none"><span
						...
						<div class="mp_qrcode" style="display: none;">
							<img src="${ctx}/images/weixin_code_145.png" /><i
